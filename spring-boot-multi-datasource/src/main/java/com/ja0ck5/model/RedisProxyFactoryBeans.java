...
public class RedisProxyFactoryBeans {
	...
	public RedisProxyFactoryBeans build() throws Exception {
		this.buildPool();
	...
	// this.maxTotal =
	// Integer.parseInt(this.properties.getProperty("maxTotal"));
	...
	// InputStream input =
	// this.getClass().getClassLoader().getResourceAsStream(propertiesPath);
